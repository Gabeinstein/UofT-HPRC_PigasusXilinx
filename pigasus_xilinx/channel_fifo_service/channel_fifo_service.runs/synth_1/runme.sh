...
HD_PWD='/home/gabriel/Desktop/go_workspace/github_repo/HPRC-PigasusXilinx/pigasus_xilinx/channel_fifo_service/channel_fifo_service.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log channel_fifo_service.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source channel_fifo_service.tcl
