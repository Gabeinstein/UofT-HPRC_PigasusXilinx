...
HD_PWD='/home/gabriel/Desktop/go_workspace/github_repo/HPRC-PigasusXilinx/pigasus_xilinx/reassembler_service/reassembler_service/reassembler_service.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reassembler_service.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reassembler_service.tcl
