...
HD_PWD='/home/gabriel/Desktop/go_workspace/github_repo/HPRC-PigasusXilinx/pigasus_xilinx/ethernet_service_multi_out/ethernet_service_multi_out.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_service_multi_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ethernet_service_multi_out.tcl
