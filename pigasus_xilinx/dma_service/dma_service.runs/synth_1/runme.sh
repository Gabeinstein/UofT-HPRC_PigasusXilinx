...
HD_PWD='/home/gabriel/Desktop/go_workspace/github_repo/HPRC-PigasusXilinx/pigasus_xilinx/dma_service/dma_service.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_service.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_service.tcl
