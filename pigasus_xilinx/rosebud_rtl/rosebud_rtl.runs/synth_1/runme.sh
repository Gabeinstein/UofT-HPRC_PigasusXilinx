...
HD_PWD='/home/gabriel/Desktop/go_workspace/github_repo/HPRC-PigasusXilinx/pigasus_xilinx/rosebud_rtl/rosebud_rtl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_accel_rd_dma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_accel_rd_dma.tcl
