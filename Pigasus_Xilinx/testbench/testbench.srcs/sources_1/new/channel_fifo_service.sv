...
module channel_fifo_service #(
    ...
    output logic [31:0] stats_out_pkt_sop,
...
logic in_ready_rosebud;
logic [511:0] out_data_rosebud;
logic out_valid_rosebud;
logic out_sop_rosebud;
logic out_eop_rosebud;
logic [5:0] out_empty_rosebud;
logic [31:0] fill_level_rosebud;

unified_pkt_fifo_rosebud #(
...
endgenerate
    ...
    stats_cnt out_pkt_inst(
        ...
        .stats_pkt_sop  (stats_out_pkt_sop)
    );
