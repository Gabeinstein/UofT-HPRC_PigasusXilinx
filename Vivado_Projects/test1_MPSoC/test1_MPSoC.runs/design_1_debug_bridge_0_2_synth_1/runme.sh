...
HD_PWD='/home/gabriel/Desktop/go_workspace/vivado_projects/test1_MPSoC/test1_MPSoC.runs/design_1_debug_bridge_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_debug_bridge_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_debug_bridge_0_2.tcl
