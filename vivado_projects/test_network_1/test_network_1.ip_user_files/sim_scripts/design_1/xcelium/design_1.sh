...
#
# Script generated by Vivado on Sat Jun 01 13:31:55 EDT 2024
...
design_libs_elab="-libname xilinx_vip -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname zynq_ultra_ps_e_vip_v1_0_14 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/gabriel/Desktop/go_workspace/vivado_projects/test_network_1/test_network_1.cache/compile_simlib/xcelium"
  fi
