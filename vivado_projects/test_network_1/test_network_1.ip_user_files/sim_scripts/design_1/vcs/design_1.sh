...
design_libs=(xilinx_vip xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/gabriel/Desktop/go_workspace/vivado_projects/test_network_1/test_network_1.cache/compile_simlib/vcs"
  fi
