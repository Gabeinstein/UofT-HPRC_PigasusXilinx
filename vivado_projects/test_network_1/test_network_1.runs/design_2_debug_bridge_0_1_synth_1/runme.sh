...
HD_PWD='/home/gabriel/Desktop/go_workspace/vivado_projects/test_network_1/test_network_1.runs/design_2_debug_bridge_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_debug_bridge_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_debug_bridge_0_1.tcl
