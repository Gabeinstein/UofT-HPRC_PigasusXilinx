...
HD_PWD='/home/gabriel/Desktop/go_workspace/vivado_projects/test_network_1/test_network_1.runs/bd_4072_bsip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_4072_bsip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_4072_bsip_0.tcl
