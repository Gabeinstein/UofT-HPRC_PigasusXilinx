...
HD_PWD='/home/gabriel/Desktop/go_workspace/vivado_projects/axi_interconect/axi_interconect.runs/design_1_debug_bridge_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_debug_bridge_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_debug_bridge_0_1.tcl
